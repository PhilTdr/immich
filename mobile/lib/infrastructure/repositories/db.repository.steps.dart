...
final class Schema32 extends i0.VersionedSchema {
  ...
  late final Shape52 localDeletionEntity = Shape52(
    source: i0.VersionedTable(
      entityName: 'local_deletion_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  late final Shape53 localDeletionExclusionEntity = Shape53(
    source: i0.VersionedTable(
      entityName: 'local_deletion_exclusion_entity',
      withoutRowId: true,
      isStrict: true,
