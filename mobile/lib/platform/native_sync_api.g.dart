...
class NativeSyncApi {
  ...
  Future<void> cancelSync() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.immich_mobile.NativeSyncApi.cancelSync$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<List<String>> getExistingAssetIds(List<String> assetIds) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.immich_mobile.NativeSyncApi.getExistingAssetIds$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
